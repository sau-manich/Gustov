                ...
                <div class="row">
                            ...
                            <div class="card__header card__header--highlight">
                                ...
                                <form class="card__body form-horizontal" action="../../../Controlador/usuarioControlador.php?opc=guardar" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="password" name="contrasena" class="form-control" placeholder="Contraseña" required autocomplete="off"><br><br>
                                        </div>
                                        <div class="col-sm-8">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card__header">
                                <h2 align="center">Usuarios Gustov <small>Por seguridad la contraseña no sera visible en esta table.</small></h2>
                            </div>
