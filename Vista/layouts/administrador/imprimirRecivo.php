    ...
    <body>
        ...
        <header id="header">
            ...
            <form class="top-search">
                <input type="text" class="top-search__input" placeholder="Busquemos por número de recibo.." disabled>
                ...
                <div class="tab-content">
                        ...
                        <div class="list-group">
                            <a href="" class="list-group-item media">
                                ...
                                <div class="media-body">
                                    ...
                                    <small class="list-group__text">Poner alguna descripción en la lista</small>
                                </div>
                            </a>
                    ...
                    <div class="tab-pane" id="notifications__tasks">
                        <div class="list-group">
                            ...
                            <div class="list-group-item">
                                <div class="list-group__heading m-b-5">Extención de Google Chrome </div>
            ...
            <aside id="navigation">
                ...
                <div class="navigation__menu c-overflow">
                    <ul>
                        ...
                        <li class="navigation__active"><a href="cobroFacturacion.php"><i class="zmdi zmdi-layers"></i> Cobro y facturación</a></li>
                        ...
                        <li class="navigation__sub">
                            <a href="" data-mae-action="submenu-toggle"><i class="zmdi zmdi-collection-item"></i> Configuración</a>
                            <ul>
                        ...
                        <div class="row invoice__address">
                            ...
                            <div class="col-xs-4">
                                <div class="text-left"><br><br>
                                    ...
                                    En caso de perder la aplicación en tu telefono, puedes descargarlo escaneando aqui.
                                </div>
                            </div>
