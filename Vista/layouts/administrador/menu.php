          ...
          function listarMenu()
          {
            ...
            //   console.log(info);
              ...
              for (var i = 0; i < data.length; i++)
              {
                ...
                $('#menuTabla').append('<td><button data-toggle="modal" href="#modal--large" class="btn btn-success btn--icon"><i class="zmdi zmdi-edit" style="color:white;"></i></button> <button class="btn btn--light btn--icon"><a href="../../../Controlador/menuControlador.php?opc=eliminarMenu&key='+data[i]['id_menu']+'"><i class="zmdi zmdi-close" style="color:white;"></i></button></td>');
